...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/ultraboost/1.webp" alt="Ultraboost">
    </div>
    <div class="carousel-item">
      <img src="img/ultraboost/2.webp" alt="Ultraboost">
    </div>
    <div class="carousel-item">
      <img src="img/ultraboost/3.webp" alt="Ultraboost">
    </div>
	<div class="carousel-item">
      <img src="img/ultraboost/4.webp" alt="Ultraboost">
    </div>
	<div class="carousel-item">
      <img src="img/ultraboost/5.webp" alt="Ultraboost">
    </div>
  </div>
...
<article class="card-body p-5">
	<h3 class="title mb-3">Ultraboost</h3>
...
<hr>
<form action="" method="post" name="boost_buyform"> <!--start of buy form-->
<input type="hidden" value=3 name="itemid"> <!--ultraboost itemid = 3 -->
	<div class="row">
		<div class="col-sm-5">
			<dl class="param param-inline">
			  <dt>Quantity: </dt>
			  <dd>
			  	<select class="form-control form-control-sm" style="width:70px;" name="quantity"> <!--boost buy quantity-->
		...
		<div class="col-sm-7">
			<dl class="param param-inline">
				  <dt>Size: </dt>
				  <dd>
			  	<select class="form-control form-control-sm" style="width:70px;" name="size"> <!--boost buy size-->
			  		<?php 
						$sql = 'SELECT size from itemstock WHERE itemId = 3 AND quantity > 0'; //ultraboost itemid = 3
						$result = $pdo->query($sql); 
						while ($row = $result->fetch()) { 
	...
	//validate quantity selected is lower than quantity have in the database
		if(isset($_POST['buy'])){
			...
			$sql = "SELECT quantity from itemstock WHERE itemId = 3 and size =:size";
